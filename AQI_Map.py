...
with map_col:
    m = folium.Map(location=[19.5, 76.5], zoom_start=7, tiles='CartoDB dark_matter')
...
with legend_col:
    ...
    <div class="legend-box">
      ...
      <p style="font-size:0.78rem;color:#94a3b8;line-height:1.5;">
        <code style="background:#0f172a;padding:2px 6px;border-radius:4px;font-size:0.75rem;">cigs = PM2.5 / 22</code><br>
      </p>
    </div>
    """, unsafe_allow_html=True)
